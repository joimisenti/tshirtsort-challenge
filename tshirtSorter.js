...
const tshirtSorter = str => {
    ...
    let sArray = strArray.filter((ele) => {
        return ele === 's';
    })
    
    let mArray = strArray.filter((ele) => {
        return ele === 'm';
    })

    let lArray = strArray.filter((ele) => {
        return ele === 'l';
    })

    return sArray.join('') + mArray.join('') + lArray.join('')
}

console.log(tshirtSorter('lms'))
console.log(tshirtSorter('lmmmslmssmsll'))